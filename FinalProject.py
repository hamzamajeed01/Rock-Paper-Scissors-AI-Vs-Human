...
images = []
image_size = 224
N_mobile = tf.keras.applications.NASNetMobile(input_shape=(
...
model.save("AIrps4.h5")
model = load_model("AIrps4.h5")
...
print("User Selected '{}' and computer selected '{}' , winner is: '{}' ".format(
    user_move, computer_move, winner))
user_move = 'paper'
computer_move = choice(['rock', 'paper', 'scissor'])
winner = findout_winner(user_move, computer_move)
print("User Selected '{}' and computer selected '{}' , winner is: '{}' ".format(
